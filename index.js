...
const main = async () => {
  ...
  server.use(cors({ origin: ["http://localhost:3000", "http://localhost:3001", "https://node-s4-exercise.vercel.app"] })); // Utilice la libreria cors para gestionar la seguridad de acceso a la API
